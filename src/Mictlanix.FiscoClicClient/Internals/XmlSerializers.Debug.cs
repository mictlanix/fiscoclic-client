...
namespace Mictlanix.FiscoClic.Client.Internals {
	internal class XmlSerializationWriter1 : System.Xml.Serialization.XmlSerializationWriter
	{
		...
		public void Write14_timbraCFDIXMLTest (object o)
		{
			WriteStartDocument ();
			if (o == null) {
				WriteNullTagLiteral (@"timbraCFDIXMLTest", @"http://srv.soap.factura.sit.mx.com");
				return;
			}
			TopLevelElement ();
			Write2_TimbraCFDIXML (@"timbraCFDIXMLTest", @"http://srv.soap.factura.sit.mx.com", ((global::Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXML)o), true, false);
		}

		public void Write15_timbraCFDIXMLTestResponse (object o)
		{
			WriteStartDocument ();
			if (o == null) {
				WriteNullTagLiteral (@"timbraCFDIXMLTestResponse", @"http://srv.soap.factura.sit.mx.com");
				return;
			}
			TopLevelElement ();
			Write3_TimbraCFDIXMLResponse (@"timbraCFDIXMLTestResponse", @"http://srv.soap.factura.sit.mx.com", ((global::Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXMLResponse)o), true, false);
		}
		...
		public void Write17_cancelaCFDITest (object o)
		{
			WriteStartDocument ();
			if (o == null) {
				WriteNullTagLiteral (@"cancelaCFDITest", @"http://srv.soap.factura.sit.mx.com");
				return;
			}
			TopLevelElement ();
			Write4_CancelaCFDI (@"cancelaCFDITest", @"http://srv.soap.factura.sit.mx.com", ((global::Mictlanix.FiscoClic.Client.Internals.CancelaCFDI)o), true, false);
		}

		public void Write18_cancelaCFDITestResponse (object o)
		{
			WriteStartDocument ();
			if (o == null) {
				WriteNullTagLiteral (@"cancelaCFDITestResponse", @"http://srv.soap.factura.sit.mx.com");
				return;
			}
			TopLevelElement ();
			Write5_CancelaCFDIResponse (@"cancelaCFDITestResponse", @"http://srv.soap.factura.sit.mx.com", ((global::Mictlanix.FiscoClic.Client.Internals.CancelaCFDIResponse)o), true, false);
		}
		...
		void Write5_CancelaCFDIResponse (string n, string ns, global::Mictlanix.FiscoClic.Client.Internals.CancelaCFDIResponse o, bool isNullable, bool needType)
		{
			...
			if (needType)
				WriteXsiType (@"cancelaCFDITestResponse", @"http://srv.soap.factura.sit.mx.com");
		...
		void Write4_CancelaCFDI (string n, string ns, global::Mictlanix.FiscoClic.Client.Internals.CancelaCFDI o, bool isNullable, bool needType)
		{
			...
			WriteStartElement (n, ns, o, false, o.@Xmlns);
			if (needType)
				WriteXsiType (@"cancelaCFDITest", @"http://srv.soap.factura.sit.mx.com");
		...
		void Write6_FiscoClicException (string n, string ns, global::Mictlanix.FiscoClic.Client.Internals.FiscoClicException o, bool isNullable, bool needType)
		{
			...
			WriteStartElement (n, ns, o, false, o.@Xmlns);
			if (needType)
				WriteXsiType (@"FiscoClicException", @"http://srv.soap.factura.sit.mx.com");
		...
		void Write3_TimbraCFDIXMLResponse (string n, string ns, global::Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXMLResponse o, bool isNullable, bool needType)
		{
			...
			WriteStartElement (n, ns, o, false, o.@Xmlns);
			if (needType)
				WriteXsiType (@"timbraCFDIXMLTestResponse", @"http://srv.soap.factura.sit.mx.com");
			WriteElementString (@"return", @"", ((global::System.String)o.@Return));
			WriteEndElement (o);
		}
		...
		void Write2_TimbraCFDIXML (string n, string ns, global::Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXML o, bool isNullable, bool needType)
		{
			...
			WriteStartElement (n, ns, o, false, o.@Xmlns);
			if (needType)
				WriteXsiType (@"timbraCFDIXMLTest", @"http://srv.soap.factura.sit.mx.com");
		...
		void Write7_SoapFaultDetail (string n, string ns, global::Mictlanix.FiscoClic.Client.Internals.SoapFaultDetail o, bool isNullable, bool needType)
		{
			...
			WriteStartElement (n, ns, o, false, null);
			if (needType)
				WriteXsiType (@"SoapFaultDetail", @"http://schemas.xmlsoap.org/soap/envelope/");
			Write6_FiscoClicException (@"FiscoClicException", @"http://srv.soap.factura.sit.mx.com", ((global::Mictlanix.FiscoClic.Client.Internals.FiscoClicException)o.@Exception), false, false);
			WriteEndElement (o);
		}
		...
		void Write9_SoapEnvelope (string n, string ns, global::Mictlanix.FiscoClic.Client.Internals.SoapEnvelope o, bool isNullable, bool needType)
		{
			...
			WriteStartElement (n, ns, o, false, o.@Xmlns);
			if (needType)
				WriteXsiType (@"Envelope", @"http://schemas.xmlsoap.org/soap/envelope/");
			{
					...
					for (int ia = 0; ia < a.Length; ia++) {
						...
						if ((object)(ai) != null) {
							if (ai is global::Mictlanix.FiscoClic.Client.Internals.SoapFault) {
								...
								Write5_CancelaCFDIResponse (@"cancelaCFDITestResponse", @"http://srv.soap.factura.sit.mx.com", ((global::Mictlanix.FiscoClic.Client.Internals.CancelaCFDIResponse)ai), true, false);
							} else if (ai is global::Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXMLResponse) {
								Write3_TimbraCFDIXMLResponse (@"timbraCFDIXMLTestResponse", @"http://srv.soap.factura.sit.mx.com", ((global::Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXMLResponse)ai), true, false);
							} else if (ai is global::Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXML) {
								Write2_TimbraCFDIXML (@"timbraCFDIXMLTest", @"http://srv.soap.factura.sit.mx.com", ((global::Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXML)ai), true, false);
							} else if (ai is global::Mictlanix.FiscoClic.Client.Internals.CancelaCFDI) {
								Write4_CancelaCFDI (@"cancelaCFDITest", @"http://srv.soap.factura.sit.mx.com", ((global::Mictlanix.FiscoClic.Client.Internals.CancelaCFDI)ai), true, false);
	...
	internal class XmlSerializationReader1 : System.Xml.Serialization.XmlSerializationReader
	{
		...
		public object Read14_timbraCFDIXMLTest ()
		{
			object o = null;
			Reader.MoveToContent ();
			if (Reader.NodeType == System.Xml.XmlNodeType.Element) {
				if (((object)Reader.LocalName == (object)id6_timbraCFDIXMLTest && (object)Reader.NamespaceURI == (object)id7_Item)) {
					o = Read2_TimbraCFDIXML (true, true);
				} else {
					throw CreateUnknownNodeException ();
				}
			} else {
				UnknownNode (null, @"http://srv.soap.factura.sit.mx.com:timbraCFDIXMLTest");
			}
			return (object)o;
		}

		public object Read15_timbraCFDIXMLTestResponse ()
		{
			object o = null;
			Reader.MoveToContent ();
			if (Reader.NodeType == System.Xml.XmlNodeType.Element) {
				if (((object)Reader.LocalName == (object)id8_timbraCFDIXMLTestResponse && (object)Reader.NamespaceURI == (object)id7_Item)) {
					o = Read3_TimbraCFDIXMLResponse (true, true);
				} else {
					throw CreateUnknownNodeException ();
				}
			} else {
				UnknownNode (null, @"http://srv.soap.factura.sit.mx.com:timbraCFDIXMLTestResponse");
			}
			return (object)o;
		}
		...
		public object Read17_cancelaCFDITest ()
		{
			object o = null;
			Reader.MoveToContent ();
			if (Reader.NodeType == System.Xml.XmlNodeType.Element) {
				if (((object)Reader.LocalName == (object)id10_cancelaCFDITest && (object)Reader.NamespaceURI == (object)id7_Item)) {
					o = Read4_CancelaCFDI (true, true);
				} else {
					throw CreateUnknownNodeException ();
				}
			} else {
				UnknownNode (null, @"http://srv.soap.factura.sit.mx.com:cancelaCFDITest");
			}
			return (object)o;
		}

		public object Read18_cancelaCFDITestResponse ()
		{
			object o = null;
			Reader.MoveToContent ();
			if (Reader.NodeType == System.Xml.XmlNodeType.Element) {
				if (((object)Reader.LocalName == (object)id11_cancelaCFDITestResponse && (object)Reader.NamespaceURI == (object)id7_Item)) {
					o = Read5_CancelaCFDIResponse (true, true);
				} else {
					throw CreateUnknownNodeException ();
				}
			} else {
				UnknownNode (null, @"http://srv.soap.factura.sit.mx.com:cancelaCFDITestResponse");
			}
			return (object)o;
		}
		...
		global::Mictlanix.FiscoClic.Client.Internals.CancelaCFDIResponse Read5_CancelaCFDIResponse (bool isNullable, bool checkType)
		{
			...
			if (isNullable)
				isNull = ReadNull ();
			if (checkType) {
				if (xsiType == null || ((object)((System.Xml.XmlQualifiedName)xsiType).Name == (object)id11_cancelaCFDITestResponse && (object)((System.Xml.XmlQualifiedName)xsiType).Namespace == (object)id7_Item)) {
				} else
		...
		global::Mictlanix.FiscoClic.Client.Internals.CancelaCFDI Read4_CancelaCFDI (bool isNullable, bool checkType)
		{
			...
			if (isNullable)
				isNull = ReadNull ();
			if (checkType) {
				if (xsiType == null || ((object)((System.Xml.XmlQualifiedName)xsiType).Name == (object)id10_cancelaCFDITest && (object)((System.Xml.XmlQualifiedName)xsiType).Namespace == (object)id7_Item)) {
				} else
					throw CreateUnknownTypeException ((System.Xml.XmlQualifiedName)xsiType);
			}
			if (isNull)
		...
		global::Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXMLResponse Read3_TimbraCFDIXMLResponse (bool isNullable, bool checkType)
		{
			...
			if (isNullable)
				isNull = ReadNull ();
			if (checkType) {
				if (xsiType == null || ((object)((System.Xml.XmlQualifiedName)xsiType).Name == (object)id8_timbraCFDIXMLTestResponse && (object)((System.Xml.XmlQualifiedName)xsiType).Namespace == (object)id7_Item)) {
				} else
					throw CreateUnknownTypeException ((System.Xml.XmlQualifiedName)xsiType);
			}
			if (isNull)
		...
		global::Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXML Read2_TimbraCFDIXML (bool isNullable, bool checkType)
		{
			...
			if (isNullable)
				isNull = ReadNull ();
			if (checkType) {
				if (xsiType == null || ((object)((System.Xml.XmlQualifiedName)xsiType).Name == (object)id6_timbraCFDIXMLTest && (object)((System.Xml.XmlQualifiedName)xsiType).Namespace == (object)id7_Item)) {
				} else
					throw CreateUnknownTypeException ((System.Xml.XmlQualifiedName)xsiType);
			}
			if (isNull)
...
//			bool[] paramsRead = new bool[2];
								...
								while (Reader.NodeType != System.Xml.XmlNodeType.EndElement && Reader.NodeType != System.Xml.XmlNodeType.None) {
									if (Reader.NodeType == System.Xml.XmlNodeType.Element) {
										if (((object)Reader.LocalName == (object)id3_Fault && (object)Reader.NamespaceURI == (object)id2_Item)) {
											...
											a_0_0 [ca_0_0++] = Read8_SoapFault (true, true);
										} else if (((object)Reader.LocalName == (object)id11_cancelaCFDITestResponse && (object)Reader.NamespaceURI == (object)id7_Item)) {
											a_0_0 = (global::System.Object[])EnsureArrayIndex (a_0_0, ca_0_0, typeof(global::System.Object));
											a_0_0 [ca_0_0++] = Read5_CancelaCFDIResponse (true, true);
										} else if (((object)Reader.LocalName == (object)id8_timbraCFDIXMLTestResponse && (object)Reader.NamespaceURI == (object)id7_Item)) {
											a_0_0 = (global::System.Object[])EnsureArrayIndex (a_0_0, ca_0_0, typeof(global::System.Object));
											a_0_0 [ca_0_0++] = Read3_TimbraCFDIXMLResponse (true, true);
										} else if (((object)Reader.LocalName == (object)id6_timbraCFDIXMLTest && (object)Reader.NamespaceURI == (object)id7_Item)) {
											a_0_0 = (global::System.Object[])EnsureArrayIndex (a_0_0, ca_0_0, typeof(global::System.Object));
											a_0_0 [ca_0_0++] = Read2_TimbraCFDIXML (true, true);
										} else if (((object)Reader.LocalName == (object)id10_cancelaCFDITest && (object)Reader.NamespaceURI == (object)id7_Item)) {
											a_0_0 = (global::System.Object[])EnsureArrayIndex (a_0_0, ca_0_0, typeof(global::System.Object));
											a_0_0 [ca_0_0++] = Read4_CancelaCFDI (true, true);
										} else {
											UnknownNode (null, @"http://schemas.xmlsoap.org/soap/envelope/:Fault, http://srv.soap.factura.sit.mx.com:cancelaCFDITestResponse, http://srv.soap.factura.sit.mx.com:timbraCFDIXMLTestResponse, http://srv.soap.factura.sit.mx.com:timbraCFDIXMLTest, http://srv.soap.factura.sit.mx.com:cancelaCFDITest");
										}
									} else {
										UnknownNode (null, @"http://schemas.xmlsoap.org/soap/envelope/:Fault, http://srv.soap.factura.sit.mx.com:cancelaCFDITestResponse, http://srv.soap.factura.sit.mx.com:timbraCFDIXMLTestResponse, http://srv.soap.factura.sit.mx.com:timbraCFDIXMLTest, http://srv.soap.factura.sit.mx.com:cancelaCFDITest");
									}
		...
		string id6_timbraCFDIXMLTest;
		string id3_Fault;
		string id23_faultstring;
		string id24_detail;
		string id8_timbraCFDIXMLTestResponse;
		string id19_campo;
		...
		string id11_cancelaCFDITestResponse;
		string id15_user;
		...
		{
			id6_timbraCFDIXMLTest = Reader.NameTable.Add (@"timbraCFDIXMLTest");
			...
			id8_timbraCFDIXMLTestResponse = Reader.NameTable.Add (@"timbraCFDIXMLTestResponse");
			...
			id10_cancelaCFDITest = Reader.NameTable.Add (@"cancelaCFDITest");
			...
			id11_cancelaCFDITestResponse = Reader.NameTable.Add (@"cancelaCFDITestResponse");
	...
	internal sealed class TimbraCFDIXMLSerializer : XmlSerializer1
	{
		...
		public override System.Boolean CanDeserialize (System.Xml.XmlReader xmlReader)
		{
			return xmlReader.IsStartElement (@"timbraCFDIXMLTest", @"http://srv.soap.factura.sit.mx.com");
		}

		protected override void Serialize (object objectToSerialize, System.Xml.Serialization.XmlSerializationWriter writer)
		{
			((XmlSerializationWriter1)writer).Write14_timbraCFDIXMLTest (objectToSerialize);
		}

		protected override object Deserialize (System.Xml.Serialization.XmlSerializationReader reader)
		{
			return ((XmlSerializationReader1)reader).Read14_timbraCFDIXMLTest ();
		}
	}
	...
	internal sealed class TimbraCFDIXMLResponseSerializer : XmlSerializer1
	{
		...
		public override System.Boolean CanDeserialize (System.Xml.XmlReader xmlReader)
		{
			return xmlReader.IsStartElement (@"timbraCFDIXMLTestResponse", @"http://srv.soap.factura.sit.mx.com");
		}

		protected override void Serialize (object objectToSerialize, System.Xml.Serialization.XmlSerializationWriter writer)
		{
			((XmlSerializationWriter1)writer).Write15_timbraCFDIXMLTestResponse (objectToSerialize);
		}

		protected override object Deserialize (System.Xml.Serialization.XmlSerializationReader reader)
		{
			return ((XmlSerializationReader1)reader).Read15_timbraCFDIXMLTestResponse ();
		}
	}
	...
	internal sealed class CancelaCFDISerializer : XmlSerializer1
	{
		...
		public override System.Boolean CanDeserialize (System.Xml.XmlReader xmlReader)
		{
			return xmlReader.IsStartElement (@"cancelaCFDITest", @"http://srv.soap.factura.sit.mx.com");
		}

		protected override void Serialize (object objectToSerialize, System.Xml.Serialization.XmlSerializationWriter writer)
		{
			((XmlSerializationWriter1)writer).Write17_cancelaCFDITest (objectToSerialize);
		}

		protected override object Deserialize (System.Xml.Serialization.XmlSerializationReader reader)
		{
			return ((XmlSerializationReader1)reader).Read17_cancelaCFDITest ();
		}
	}
	...
	internal sealed class CancelaCFDIResponseSerializer : XmlSerializer1
	{
		...
		public override System.Boolean CanDeserialize (System.Xml.XmlReader xmlReader)
		{
			return xmlReader.IsStartElement (@"cancelaCFDITestResponse", @"http://srv.soap.factura.sit.mx.com");
		}

		protected override void Serialize (object objectToSerialize, System.Xml.Serialization.XmlSerializationWriter writer)
		{
			((XmlSerializationWriter1)writer).Write18_cancelaCFDITestResponse (objectToSerialize);
		}

		protected override object Deserialize (System.Xml.Serialization.XmlSerializationReader reader)
		{
			return ((XmlSerializationReader1)reader).Read18_cancelaCFDITestResponse ();
		}
	}
	...
	internal class XmlSerializerContract : global::System.Xml.Serialization.XmlSerializerImplementation
	{
		...
		public override System.Collections.Hashtable ReadMethods {
			get {
				if (readMethods == null) {
					...
					_tmp [@"Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXML:http://srv.soap.factura.sit.mx.com:timbraCFDIXMLTest:False:"] = @"Read14_timbraCFDIXMLTest";
					_tmp [@"Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXMLResponse:http://srv.soap.factura.sit.mx.com:timbraCFDIXMLTestResponse:False:"] = @"Read15_timbraCFDIXMLTestResponse";
					...
					_tmp [@"Mictlanix.FiscoClic.Client.Internals.CancelaCFDI:http://srv.soap.factura.sit.mx.com:cancelaCFDITest:False:"] = @"Read17_cancelaCFDITest";
					_tmp [@"Mictlanix.FiscoClic.Client.Internals.CancelaCFDIResponse:http://srv.soap.factura.sit.mx.com:cancelaCFDITestResponse:False:"] = @"Read18_cancelaCFDITestResponse";
					if (readMethods == null)
						readMethods = _tmp;
				}
				return readMethods;
		...
		public override System.Collections.Hashtable WriteMethods {
			get {
				if (writeMethods == null) {
					...
					_tmp [@"Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXML:http://srv.soap.factura.sit.mx.com:timbraCFDIXMLTest:False:"] = @"Write14_timbraCFDIXMLTest";
					_tmp [@"Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXMLResponse:http://srv.soap.factura.sit.mx.com:timbraCFDIXMLTestResponse:False:"] = @"Write15_timbraCFDIXMLTestResponse";
					...
					_tmp [@"Mictlanix.FiscoClic.Client.Internals.CancelaCFDI:http://srv.soap.factura.sit.mx.com:cancelaCFDITest:False:"] = @"Write17_cancelaCFDITest";
					_tmp [@"Mictlanix.FiscoClic.Client.Internals.CancelaCFDIResponse:http://srv.soap.factura.sit.mx.com:cancelaCFDITestResponse:False:"] = @"Write18_cancelaCFDITestResponse";
					if (writeMethods == null)
						writeMethods = _tmp;
				}
				return writeMethods;
		...
		public override System.Collections.Hashtable TypedSerializers {
			get {
				if (typedSerializers == null) {
					...
					_tmp.Add (@"Mictlanix.FiscoClic.Client.Internals.CancelaCFDIResponse:http://srv.soap.factura.sit.mx.com:cancelaCFDITestResponse:False:", new CancelaCFDIResponseSerializer ());
					_tmp.Add (@"Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXML:http://srv.soap.factura.sit.mx.com:timbraCFDIXMLTest:False:", new TimbraCFDIXMLSerializer ());
					_tmp.Add (@"Mictlanix.FiscoClic.Client.Internals.CancelaCFDI:http://srv.soap.factura.sit.mx.com:cancelaCFDITest:False:", new CancelaCFDISerializer ());
					...
					_tmp.Add (@"Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXMLResponse:http://srv.soap.factura.sit.mx.com:timbraCFDIXMLTestResponse:False:", new TimbraCFDIXMLResponseSerializer ());
					if (typedSerializers == null)
		...
		{
			if (type == typeof(global::Mictlanix.FiscoClic.Client.Internals.SoapEnvelope))
				return true;
			if (type == typeof(global::Mictlanix.FiscoClic.Client.Internals.SoapFault))
				return true;
			if (type == typeof(global::Mictlanix.FiscoClic.Client.Internals.SoapFaultDetail))
				return true;
			if (type == typeof(global::Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXML))
				return true;
			if (type == typeof(global::Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXMLResponse))
				return true;
			if (type == typeof(global::Mictlanix.FiscoClic.Client.Internals.FiscoClicException))
				return true;
			if (type == typeof(global::Mictlanix.FiscoClic.Client.Internals.CancelaCFDI))
				return true;
			if (type == typeof(global::Mictlanix.FiscoClic.Client.Internals.CancelaCFDIResponse))
				return true;
			return false;
		}
		...
		public override System.Xml.Serialization.XmlSerializer GetSerializer (System.Type type)
		{
			...
			if (type == typeof(global::Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXML))
				return new TimbraCFDIXMLSerializer ();
			if (type == typeof(global::Mictlanix.FiscoClic.Client.Internals.TimbraCFDIXMLResponse))
				return new TimbraCFDIXMLResponseSerializer ();
			if (type == typeof(global::Mictlanix.FiscoClic.Client.Internals.FiscoClicException))
				return new FiscoClicExceptionSerializer ();
			if (type == typeof(global::Mictlanix.FiscoClic.Client.Internals.CancelaCFDI))
				return new CancelaCFDISerializer ();
			if (type == typeof(global::Mictlanix.FiscoClic.Client.Internals.CancelaCFDIResponse))
				return new CancelaCFDIResponseSerializer ();
			return null;
		}
	}
}
